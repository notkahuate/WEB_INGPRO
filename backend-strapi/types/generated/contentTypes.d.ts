...
export interface ApiClienteCliente extends Schema.CollectionType {
  ...
  info: {
    description: 'Usuarios registrados del sitio (equivalente a tabla usuarios)';
    displayName: 'Cliente';
    pluralName: 'clientes';
  ...
  attributes: {
    ...
    estado_provincia: Attribute.String;
    legacy_id: Attribute.Integer & Attribute.Unique;
    nombre: Attribute.String & Attribute.Required;
    nombre_empresa: Attribute.String;
    pais: Attribute.String;
    password_hash: Attribute.String & Attribute.Private;
...
export interface ApiCotizacionCotizacion extends Schema.CollectionType {
  ...
  attributes: {
    codigo_oportunidad: Attribute.String;
    createdAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
    ...
    legacy_id: Attribute.Integer & Attribute.Unique;
    legacy_user_id: Attribute.Integer;
    productos: Attribute.JSON & Attribute.Required;
    total_productos: Attribute.Decimal;
    updatedAt: Attribute.DateTime;
    updatedBy: Attribute.Relation<
      'api::cotizacion.cotizacion',
      'oneToOne',
...
export interface ApiProductoProducto extends Schema.CollectionType {
  ...
  info: {
    description: 'Cat\u00E1logo de productos INGPRO';
  ...
  attributes: {
    ...
    cf_categoria: Attribute.String;
    cf_category: Attribute.String;
    cf_codigo: Attribute.String;
    cf_codigo_categoria: Attribute.String;
    cf_en_el_paquete: Attribute.Text;
    cf_garant_a: Attribute.String;
    cf_item: Attribute.String;
    cf_marca: Attribute.String;
    cf_subcategoria: Attribute.String;
    cf_t_entrega: Attribute.String;
    config_options: Attribute.JSON;
    ...
    > &
      Attribute.Private;
    datasheet_url: Attribute.String;
    description: Attribute.JSON;
    especificaciones: Attribute.JSON;
    image_name: Attribute.String;
    imagen_url: Attribute.String;
    imagenes_url: Attribute.JSON;
    item_id: Attribute.String & Attribute.Required & Attribute.Unique;
    last_modified_time: Attribute.DateTime;
    name: Attribute.Text;
    origen: Attribute.String;
    rate: Attribute.Decimal;
    secciones: Attribute.Relation<
      'api::producto.producto',
      'oneToMany',
      'api::seccion.seccion'
    >;
    ...
    stock_on_hand: Attribute.Integer;
    tablas: Attribute.JSON;
    updatedAt: Attribute.DateTime;
    updatedBy: Attribute.Relation<
      'api::producto.producto',
      'oneToOne',
...
export interface ApiSeccionSeccion extends Schema.CollectionType {
  ...
  info: {
    description: 'Secciones de contenido e im\u00E1genes vinculadas a un producto';
    displayName: 'Seccion';
  ...
  attributes: {
    ...
    informacion: Attribute.RichText;
